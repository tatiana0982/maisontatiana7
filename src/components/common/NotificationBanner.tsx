...
const notifications = [
  { message: 'Receive a surprise gift with every order.', link: { text: 'Discover', href: '/products' } },
  { message: 'Follow @maisontatiana7 for exclusive updates.', link: { text: 'Follow Us', href: 'https://www.instagram.com/maisontatiana7/' } },
  { message: 'Limited Edition: The exclusive collection has arrived.', link: { text: 'Shop Now', href: '/products' } },
  { message: 'Discover our new handcrafted fragrances from France.', link: { text: 'Explore', href: '/products' } },
  { message: 'A scent for every moment curated sets now available.', link: { text: 'Select Samples', href: '/products' } },
  { message: 'Experience the essence of luxury with our new arrivals.', link: { text: 'View Collection', href: '/products' } },
  { message: 'Join our fragrance community for exclusive offers.', link: { text: 'Join Now', href: '/products' } },
  { message: 'Explore our artisanal perfumes crafted in France.', link: { text: 'Shop Artisanal', href: '/products' } },
  { message: 'Discover the art of gifting with personalized scents.', link: { text: 'Explore Gifts', href: '/products' } },
  { message: 'Experience the essence of luxury with our new arrivals.', link: { text: 'View Collection', href: '/products' } },
  { message: 'Discover the perfect scent for every occasion.', link: { text: 'Find Your Scent', href: '/products' } },
  { message: 'Join our fragrance journey and explore new horizons.', link: { text: 'Join Journey', href: '/about' } },
];
