        ...
        <div className="bg-white rounded-lg p-6 lg:p-12">
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-2 max-w-lg">
                  <EditText 
                    ...
                    variant="outline"
                  />
                  {/* CORRECTED: Explicitly styled the button for a black background and white text */}
                  <Button 
                    size="md" 
          ...
          <div className="border-t pt-8 flex flex-col lg:flex-row justify-between items-center gap-8">
            ...
            <div className="order-1 lg:order-2">
              <a href="#"><Image src="/images/img_image_2.png" width={200} height={42} alt="Maison Tatiana 7 Logo"/></a>
            </div>
